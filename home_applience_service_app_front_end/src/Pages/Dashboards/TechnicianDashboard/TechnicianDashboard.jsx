...
//                 alt="Workflow"
//               />
//               <p className="mx-10 text-white">Technician</p>
//             </div>
...
//                   <div className="py-4">
//                     {selectedNavItem.name === "Product Details" ? (
//                       // Render blank component or leave empty
//                       <div></div>
//                     ) : (
//                       // Render ServiceRequests component when other navigation items are selected
